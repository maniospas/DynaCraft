...
#
#     def is_empty(self):
#         return not self.fields and not self.types
#
#     def __getattr__(self, name, use_default=False):
#         if  use_default:
#             # Return the original __getattr__ only if use_default is False
#             print(f"{self}, {name}")
...
#
#     def __str__(self):
#         #otan kanw print to object na mou leei type kai fields
#         return f"This is an object with types {self.types} and value {self.fields}"
